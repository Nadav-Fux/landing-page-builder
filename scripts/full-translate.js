...
const translations = {
    ...
    'The complete toolkit for app marketers. From landing pages to promo videos, we have everything you need to drive downloads.': 'ערכת הכלים המלאה למשווקי אפליקציות. מדפי נחיתה ועד סרטוני קידום, יש לנו את כל מה שצריך כדי להגדיל הורדות.',
    ...
    'Event Conference': 'כנסים ואירועים',
    ...
    // Newsletter
    'Expert Financial Consulting': 'ייעוץ פיננסי מומחה',
    ...
    'Wedding & Events': 'חתונות ואירועים',
    ...
    // Online Course
    'Online Course': 'קורס מקוון',
    'Launch Your Online Course': 'השק את הקורס המקוון שלך',
    'Everything you need to create and sell your online course.': 'כל מה שצריך כדי ליצור ולמכור את הקורס המקוון שלך.',
    ...
    'Join thousands of satisfied customers today.': 'הצטרף לאלפי לקוחות מרוצים היום.',
    'Get started for free': 'התחל בחינם',
    
    // Additional feature titles
    'What You Get': 'מה תקבל',
    'Why Choose Us': 'למה לבחור בנו',
    'Our Process': 'התהליך שלנו',
    'How It Works': 'איך זה עובד',
    
    // Additional feature descriptions
    'Everything you need': 'כל מה שאתה צריך',
    'Proven results': 'תוצאות מוכחות',
    'Expert team': 'צוות מומחים',
    
    // More buttons
    'Get Started Free': 'התחל בחינם',
    'Learn More About': 'למד עוד על',
    'View All Features': 'צפה בכל התכונות',
    'Get Started Now': 'התחל עכשיו',
    'Start Your Journey': 'התחל את המסע שלך',
    
    // More hero subtitles
    'The most powerful platform for creating stunning landing pages.': 'הפלטפורמה החזקה ביותר ליצירת דפי נחיתה מרהיבים.',
    'Create, launch, and grow your online presence.': 'צור, השק, ופתח את הנוכחות שלך באינטרנט.',
    
    // Stats variations
    'Years On Market': 'שנות ניסיון בשוק',
    'Customer Satisfaction': 'שביעות רצון לקוחות',
    'Products Sold': 'מוצרים שנמכרו',
    'Daily Visitors': 'מבקרים יומיים',
    
    // Feature variations
    'Premium Quality': 'איכות פרימיום',
    'Fast Delivery': 'משלוח מהיר',
    'Secure Payment': 'תשלום מאובטח',
    'Easy Returns': 'החזרות קלות',
    ...
    // FAQ answers
    'Everything you need to succeed is included in your subscription.': 'כל מה שצריך כדי להצליח כלול במנוי שלך.',
    'It\'s simple - just sign up, create your page, and launch!': 'פשוט - פשוט הירשם, צור את הדף שלך, והשק!',
    'Yes, you can cancel your subscription at any time with no penalties.': 'כן, אפשר לבטל את המנוי בכל עת ללא קנסות.',
    'Yes, we offer a 14-day free trial for new users.': 'כן, אנו מציעים 14 ימי ניסיון חינם למשתמשים חדשים.',
    'We accept all major credit cards, PayPal, and bank transfers.': 'אנו מקבלים כרטיסי אשראי עיקריים, PayPal והעברות בנקאיות.',
    'Yes, we offer a 30-day money-back guarantee.': 'כן, אנו מציעים 30 יום החזר כספי מלא.',
    'You can reach our support team via email or live chat.': 'אפשר ליצור קשר עם צוות התמיכה באימייל או בצ\'אט.',
    'Yes, we use industry-leading encryption to protect your data.': 'כן, אנו משתמשים בהצפנה מובילה בתעשייה להגנה על הנתונים שלך.',
    ...
    // CTA variants
    'Get Started Today': 'התחל היום',
    'Start Your Free Trial': 'התחל תקופת ניסיון חינם',
    'Contact Sales': 'צור קשר עם מכירות',
    
    // More subtitles
    'Join thousands of creators who trust us.': 'הצטרף לאלפי יוצרים שסומכים עלינו.',
    'Turn visitors into customers with proven strategies.': 'הפוך מבקרים ללקוחות עם אסטרטגיות מוכחות.',
    'Build your online presence the smart way.': 'בנה את הנוכחות שלך באינטרנט בצורה חכמה.',
    
    // Additional feature titles
    'Unlimited Pages': 'דפים ללא הגבלה',
    'Custom Domains': 'דומיינים מותאמים',
    'SEO Optimization': 'אופטימיזציה ל SEO',
    'Analytics Dashboard': 'לוח בקרה לאנליטיקס',
    'A/B Testing': 'בדיקות A/B',
    'Email Marketing': 'שיווק באימייל',
    
    // Feature desc variations
    'Create as many pages as you need.': 'צור כמה דפים שאתה צריך.',
    'Use your own domain name.': 'השתמש בשם הדומיין שלך.',
    'Rank higher in search engines.': 'דרג גבוה יותר במנועי חיפוש.',
    'Track your performance in real-time.': 'עקוב אחר הביצועים שלך בזמן אמת.',
    'Test different versions of your pages.': 'בדוק גרסאות שונות של הדפים שלך.',
    'Send targeted email campaigns.': 'שלח קמפיינים ממוקדים באימייל.',
...
function toBilingual(text) {
    if (isBilingualText(text)) return text;
    if (typeof text !== 'string') return text;
    const hebrew = getHebrewTranslation(text);
    return {
        en: text,
        he: hebrew
    };
...
function convertComponent(component) {
    ...
    const bilingualFields = [
        ...
        'copyright', 'period', 'badge'
    ];
    
    for (const field of bilingualFields) {
        if (typeof converted.props[field] === 'string') {
            converted.props[field] = toBilingual(converted.props[field]);
        }
    }
    ...
    if (Array.isArray(converted.props.features)) {
        converted.props.features = converted.props.features.map(feature => {
            ...
            if (typeof feature.title === 'string') {
                result.title = toBilingual(feature.title);
            }
            if (typeof feature.description === 'string') {
                result.description = toBilingual(feature.description);
            }
            return result;
        });
    }
    ...
    if (Array.isArray(converted.props.tiers)) {
        converted.props.tiers = converted.props.tiers.map(tier => {
            ...
            if (typeof tier.name === 'string') {
                result.name = toBilingual(tier.name);
            }
            if (typeof tier.description === 'string') {
                result.description = toBilingual(tier.description);
            }
            if (typeof tier.buttonText === 'string') {
                result.buttonText = toBilingual(tier.buttonText);
            }
            if (Array.isArray(tier.features)) {
                result.features = tier.features.map(f => {
                    const featResult = { ...f };
                    if (typeof f.text === 'string') {
                        featResult.text = toBilingual(f.text);
                    }
                    return featResult;
                });
            }
    ...
    if (Array.isArray(converted.props.testimonials)) {
        converted.props.testimonials = converted.props.testimonials.map(t => {
            ...
            if (typeof t.content === 'string') {
                result.content = toBilingual(t.content);
            }
            if (typeof t.role === 'string') {
                result.role = toBilingual(t.role);
            }
            return result;
        });
    }
    ...
    if (Array.isArray(converted.props.items)) {
        converted.props.items = converted.props.items.map(item => {
            ...
            if (typeof item.question === 'string') {
                result.question = toBilingual(item.question);
            }
            if (typeof item.answer === 'string') {
                result.answer = toBilingual(item.answer);
            }
            return result;
        });
    }
    ...
    if (Array.isArray(converted.props.stats)) {
        converted.props.stats = converted.props.stats.map(stat => {
            ...
            if (typeof stat.label === 'string') {
                result.label = toBilingual(stat.label);
            }
            return result;
        });
    }
    ...
    if (Array.isArray(converted.props.columns)) {
        converted.props.columns = converted.props.columns.map(col => {
            ...
            if (typeof col.title === 'string') {
                result.title = toBilingual(col.title);
            }
            if (Array.isArray(col.links)) {
                result.links = col.links.map(l => ({
                    ...l,
                    label: toBilingual(l.label)
                }));
            }
            return result;
        });
    ...
    if (Array.isArray(converted.props.socialLinks)) {
        converted.props.socialLinks = converted.props.socialLinks.map(link => ({
            ...link,
        ...
        if (converted.puckData.root && converted.puckData.root.props) {
            converted.puckData.root = {
                ...
                props: {
                    ...
                    dir: toBilingual(converted.puckData.root.props.dir || 'ltr'),
                    lang: toBilingual(converted.puckData.root.props.lang || 'en')
                }
            };
        }
    }
...
function convertAllTemplates() {
    ...
    console.log(`\n✅ Updated ${converted} templates with full Hebrew translations!`);
}

...
export const Footer: React.FC<FooterProps> = ({
    logo,
    logoText = "PageCraft",
    description = "Build beautiful landing pages in minutes with our AI-powered builder.",
            ...
            <div className="max-w-7xl mx-auto">
                                ...
                                <a
                                    ...
                                    className={cn(
                                        ...
                                        isDark
                                            ...
                                            : "text-gray-500 hover:text-gray-700 hover:bg-gray-200 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800"
                                    )}
                ...
                >
                    <p
                        className={cn(
                            "text-sm text-center",
                            isDark ? "text-gray-500" : "text-gray-500 dark:text-gray-500"
                        )}
                    >
                        {copyright}
                    </p>
